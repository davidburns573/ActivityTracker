...
abstract class Database {
    ...
    */
     ...
     * The deletions must be process AFTER the movements.
     * @param activityListDiffMap is generated by to show differences from activity changes
     */
    abstract fun executeListDiff(activityListDiffMap: ListDiffMap<Activity>)
}